...
class TitleState extends MusicBeatState
{
	...
	var backgroundTittle:FlxSprite;
...
//	var gfDance:FlxSprite;
	...
	function startIntro()
	{
		...
		backgroundTittle = new FlxSprite().loadGraphic(Paths.image('titleBG'));
		backgroundTittle.screenCenter();
		backgroundTittle.antialiasing = ClientPrefs.globalAntialiasing;
...
//<		gfDance.shader = swagShader.shader;
		add(backgroundTittle); // Fondo del Titulo
		add(logoBl);
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('weones'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Mod dirigido por'], 15);
					#else
